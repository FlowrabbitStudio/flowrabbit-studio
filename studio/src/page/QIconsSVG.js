export const icons = {
    ...
    'AIChat': `
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        <path d="M12.007 19.98a9.869 9.869 0 0 1 -4.307 -.98l-4.7 1l1.3 -3.9c-2.324 -3.437 -1.426 -7.872 2.1 -10.374c3.526 -2.501 8.59 -2.296 11.845 .48c1.992 1.7 2.93 4.04 2.747 6" />
        <path d="M9 9h1" />
        <path d="M9 13h2.5" />
        <path d="M9 17h1" />
        <path d="M14 21v-4a2 2 0 1 1 4 0v4" />
    ...
    `,
    'ComponentContained': `
        <path d="M1 10L4 13L7 10L4 7L1 10Z" fill="black" stroke="black" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M13 10L16 13L19 10L16 7L13 10Z" fill="black" stroke="black" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M7 4L10 7L13 4L10 1L7 4Z" fill="black" stroke="black" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M7 16L10 19L13 16L10 13L7 16Z" fill="black" stroke="black" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
    `,
    'AddWidget': `
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
   ...
   `,
    ...
    'CreateBasic': `
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        <path d="M12.5 21h-4.5a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v7"></path>
        <path d="M16 19h6"></path>
        <path d="M19 16v6"></path>
        <path d="M11 4h2"></path>
        <path d="M12 17v.01"></path>
    ...
    'VectorBezier': `
        ...
        <path d="M17 5c-6.627 0 -12 5.373 -12 12"></path>
    `,
    'VectorTriangle': `
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
    ...
    'VectorRectangle': `
        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        <path d="M3 3m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z"></path>
        <path d="M17 3m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z"></path>
        <path d="M17 17m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z"></path>
        <path d="M3 17m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z"></path>
    ...
    'VectorBezier2': `
        ...
        <path d="M3 3m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z"></path>
        <path d="M17 17m0 1a1 1 0 0 1 1 -1h2a1 1 0 0 1 1 1v2a1 1 0 0 1 -1 1h-2a1 1 0 0 1 -1 -1z"></path>
        <path d="M7 5l7 0"></path>
        <path d="M10 19l7 0"></path>
   ...
   'ChartBubble': `
    ...
    `,
    'Projects': `
        <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 4m0 1a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" />
    ...
    'Separator': `
       ...
       <path d="M7 12l10 0"></path> <path d="M21 12l0 .01"></path> 
    `,
    'Height': `
    ...
    `,
    'MessageUser': `             
        <path d="M13 18l-5 3v-3h-2a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12a3 3 0 0 1 3 3v4.5"></path>
    ...
    'Prompt': `       
        ...
        <path d="M20 11.5v-2.5a2 2 0 0 0 -2 -2h-12a2 2 0 0 0 -2 2v5a2 2 0 0 0 2 2h7"></path>
    `,
    'SystemPrompt': `       
