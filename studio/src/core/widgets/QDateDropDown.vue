...
<template>
  <div class="MatcWidgetTypeDropDown MatcWidgetTypeDateDropDown">
    <div data-dojo-attach-point="button" class="MatcWidgetTypeDropDownCntr MatcWidgetTypeDateDropDownCntr">
...
export default {
  ...
  methods: {
    ...
    getPopupStyle() {
      ...
      console.debug('getPop', this.style.popupBackground)
