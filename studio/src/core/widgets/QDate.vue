...
export default {
  ...
  methods: {
    ...
    render (model, style, scaleX, scaleY) {
      ...
      this.nextButtonLbl.innerHTML = '<i class="mdi mdi-chevron-right"></i>';
      this.lastButtonLbl.innerHTML = '<i class="mdi mdi-chevron-left"></i>';
      ...
      if (style.headerColor) {
        ...
        this.nextButton.style.color = style.headerColor;
        this.lastButton.style.color = style.headerColor;
      }

      if (style.headerFontWeight) {
        this.header.style.fontWeight = style.headerFontWeight;
      }

      if (style.borderColor) {
        this.nextButton.style.borderColor = style.borderColor;
        this.nextButton.style.borderStyle = "solid";
        this.lastButton.style.borderColor = style.borderColor;
        this.lastButton.style.borderStyle = "solid";
        this.nextButton.style.borderWidth = style.borderWidth + "px";
        this.lastButton.style.borderWidth = style.borderWidth + "px";
      }

      if (style.headerBorderColor) {
        this.header.style.borderColor = style.headerBorderColor;
        this.header.style.borderStyle = "solid";
      }
      if (style.headerBorderWidth) {
        this.header.style.borderWidth = style.headerBorderWidth + "px";
      }
      if (style.headerBorderRadius) {
        this.header.style.borderRadius = style.headerBorderRadius + "px";
      }
      ...
      if (this.tblHeaderTds) {
        for (var i = 0; i < this.tblHeaderTds.length; i++) {
          ...
          if (style.tableHeaderBorderRadius) {
            td.style.borderRadius = style.tableHeaderBorderRadius + "px";
          }
          if (style.tableHeaderBorderColor) {
            td.style.borderColor = style.tableHeaderBorderColor;
            td.style.borderStyle = "solid"; 
          }
          if (style.tableHeaderBorderWidth) {
            td.style.borderWidth = style.tableHeaderBorderWidth + "px";
          }
        }
      }
    ...
    renderSelectedDay (qDate, inRange) {
      ...
      if (this.dayTds && this.dayTds[key]) {
        ...
        if (style.selectedBorderColor) {
          td.style.borderColor = style.selectedBorderColor;
          td.style.borderStyle = "solid"; 
        }
        if (style.selectedBorderWidth) {
          td.style.borderWidth = style.selectedBorderWidth + "px";
        }
        if (!inRange && style.selectedBorderRadius) {
          td.style.borderRadius = style.selectedBorderRadius + "px";
        }
    ...
    setValue: function(value, doNotMark = false, ignoreValidation) {
      if (value) {
        if (this.isRange) {
          /**
