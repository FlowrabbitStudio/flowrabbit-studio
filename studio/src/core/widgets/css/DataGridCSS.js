...
export default class TableCSS {
    ...
    run (selector, style, widget) {
        ...
        result += selector + ' tbody tr:nth-child(even){\n'
        result += `  background:${style.evenRowBackground};\n`
        result += `  color:${style.evenRowColor};\n`
        result += '}\n\n'

        result += selector + ' tbody tr:nth-child(odd){\n'
        ...
        if (widget.props.tableActions) {
            widget.props.tableActions.forEach((action, i) => {
                ...
                if (action.color) {
                    ...
                    result += `  background:${action.background};\n`
                }
                result += '}\n\n'
            })
        }
        ...
        if (widget.props.columns) {
            widget.props.columns.forEach((col, i) => {
                result += selector + ' .qux-table-column-style-' + i + '{\n'
                if (col.background) {
