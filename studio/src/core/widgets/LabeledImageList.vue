<template>
    <div class="MatcWidgetTypeLabeledImageList">
        <div v-if="images.length === 0">
            No Images
        </div>
        <div v-else :class="'MatcWidgetTypeLabeledImageListCntr ' + layout" 
            :style="{
              'gap': gap + 'px',
            ...
            <div v-for="(img, i) in images" :key="i">
                <div 
                  ...
                  :class="['MatcWidgetTypeLabeledImageListImage', {'MatcWidgetTypeLabeledImageListPlaceholder': img.placeholder }]" 
                >
                  <i v-if="img.placeholder" class="mdi mdi-image"></i>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        render(model, style, scaleX, scaleY) {
            ...
            if (this.model.props.images && this.model.props.images.length) {
                this.images = this.model.props.images.map(i => {
                    return {
