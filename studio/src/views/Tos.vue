          ...
          <div class="column is-9">
            <div class="content">
              ...
              <p>
                ...
                website. This website uses cookies. By using this website and
                agreeing to these terms and conditions, you consent to our
                <b>{{ host }}</b> 's use of cookies in accordance with the terms of
                <b>{{ host }}</b> 's privacy policy.
              </p>

              <h3>License to use website</h3>

              <p>
                Unless otherwise stated, <b>{{ host }}</b> and/or its licensors own the
              ...
              <p>
                ...
                website without <b>{{ host }}</b> s express written consent.
              </p>
              <p>
                You must not use this website for any purposes related to
                marketing without <b>{{ host }}</b> s express written consent.
              </p>

              <h3>Restricted access</h3>

              <p>
                <b>{{ host }}</b> reserves the right to restrict access to [other] areas
                of this website, or indeed this entire website.
              </p>

              <p>
                If <b>{{ host }}</b> provides you with a user ID and password to enable
              ...
              <p>
                <b>{{ host }}</b> may disable your user ID and password in sole
              ...
              <p>
                ...
                of giving rise to legal action whether against you or <b>{{ host }}</b>
              ...
              <p>
                <b>{{ host }}</b> reserves the right to remove any material submitted to
                this website, or stored on <b>{{ host }}</b> s servers, or hosted or
                published upon this website.
              </p>

              <p>
                You grant to <b>{{ host }}</b> a worldwide, irrevocable, non-exclusive,
                royalty-free license to use your content for internal analysis
              ...
              <p>
                ...
                warranties, express or implied. <b>{{ host }}</b> makes no
              ...
              <p>
                ...
                <b>{{ host }}</b> does not warrant that:
              </p>
              ...
              <p>
                <b>{{ host }}</b> will not be liable to you (whether under the law of
              ...
              <p>
                These limitations of liability apply even if <b>{{ host }}</b> has been
              ...
              <p>
                ...
                limit <b>{{ host }}</b> s liability in respect of any:
              </p>

              <ul>
                <li>
                  death or personal injury caused by <b>{{ host }}</b> s negligence;
                </li>
                <li>
                  fraud or fraudulent misrepresentation on the part of <b>{{ host }}</b> ;
                  or
                </li>
                <li>
                  matter which it would be illegal or unlawful for <b>{{ host }}</b> to
              ...
              <p>
                You accept that, as a limited liability entity, <b>{{ host }}</b> has an
                interest in limiting the personal liability of its
                collaborators. You agree that you will not bring any claim
                personally against <b>{{ host }}</b> s officers or employees in respect of
              ...
              <p>
                ...
                disclaimer will protect <b>{{ host }}</b> s officers, employees, agents,
              ...
              <p>
                You hereby indemnify <b>{{ host }}</b> and undertake to keep <b>{{ host }}</b>
                indemnified against any losses, damages, costs, liabilities and
                expenses (including without limitation legal expenses and any
                amounts paid by <b>{{ host }}</b> to a third party in settlement of a
                claim or dispute on the advice of <b>{{ host }}</b> s legal advisers)
                incurred or suffered by <b>{{ host }}</b> arising out of any breach by
              ...
              <p>
                Without prejudice to <b>{{ host }}</b> s other rights under these terms
                and conditions, if you breach these terms and conditions in any
                way, <b>{{ host }}</b> may take such action as <b>{{ host }}</b> deems appropriate
              ...
              <p>
                <b>{{ host }}</b> may revise these terms and conditions from
              ...
              <p>
                <b>{{ host }}</b> may transfer, sub-contract or otherwise deal with
                [<b>{{ host }}</b> s rights and/or obligations under these terms and
              ...
              <p>
                ...
                between you and <b>{{ host }}</b> in relation to your use of this
