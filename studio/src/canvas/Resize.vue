...
export default {
    ...
    methods: {
      ...
      registerResizeListener (div, parent, id, type, modelType){
        ...
        const listener = on(div,"mousedown", lang.hitch(this,"onResizeDnDStart", div,parent, id, type, modelType));
      ...
      registerPrototypingHandler (div){
        ...
        const listener = on(div,"mousedown", (e) => {
           this.stopEvent(e)
           this.addDefaultLine(e, true)
        });
        this._resizeHandleListeners.push(listener);
      },
        ...
        if (modelType !== "group" && modelType !== "multi"){
          ...
          if (this._resizeModelType == "screen"){
            ...
            if (sourcePos) {
              ...
              this.updateSegmentScreenLines(widget, zoomedPos)
            } else {
