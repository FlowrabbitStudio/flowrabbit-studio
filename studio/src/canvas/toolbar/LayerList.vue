		...
		getNodeIcon (box, type){
			...
			if (box.template) {
				if (box.isRootTemplate) {
					return "mdi mdi-rhombus-split";
				} else {
					return "mdi mdi-rhombus-split-outline"; // return "mdi mdi mdi-border-all-variant MatcIcon45";
				}
			}
			...
			if (box.type === 'Repeater') {
				if (box?.props.layout === "rows") {
					return 'mdi mdi-view-agenda-outline'
				} else {
					return 'mdi mdi-view-grid-outline'
				}
