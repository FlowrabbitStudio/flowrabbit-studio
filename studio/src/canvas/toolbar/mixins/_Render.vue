...
import DataBindingLinks from 'canvas/toolbar/components/DataBindingLinks'
...
import ThemeVariableList from 'canvas/toolbar/components/ThemeVariableList'

import Services from 'services/Services'
import HelperUtil from '../../../util/HelperUtil'
import {iconDOM} from '../../../page/QIconUtil'
import ToolbarDropUpButton from '../components/ToolbarDropUpButton.vue'
    ...
    data: function () {
        return {
			hasPadding : ["Button", "DateDropDown", "DropDown", "TypeAheadTextBox", "MobileDropDown", "Label", "TextBox", 'LockSlider',
						...
						'VerticalNavigation', 'Paging' ,'LabeledTextBox', 'NavBar', 'NavMenu', 'Chat', 'TabBar', 'DataGrid', 
						'AudioPlayer', 'GeoLocation', 'LabeledImageList', 'Date'],
			...
			hasData : ["ToggleButton", "DateDropDown", "SegmentButton", "SegmentPicker", "DropDown", "MobileDropDown", "TextBox", "TextArea", "Password",
						...
						"LabeledIconToggle", "LogicOr", "CheckBoxGroup", "RadioGroup", "Repeater", "Camera", "Rest", "AIRest", 'LockSlider', "StackedRingChart",
						'ProgressBar', 'ScreenSegment', 'CountingStepper', "Tree", "VerticalNavigation", 'IconButton', 'Timeline', 'VisualPicker', 
						'Script', 'IconToggleButton', 'ProgressSegments', 'ImagePaging', 'LabeledCheckBox', 'LabeledRadioBox', 
						'LabeledTextBox', 'NavBar', 'NavMenu', 'OpenAIAssistant', 'Chat','PromptBuilder', 'TabBar', 'DataGrid', 
						'IFrameWidget', 'AudioPlayer', 'AudioRecording', "API", "DocToText", "TextToDoc", 
						"CopyClipboard", 'GeoLocation', 'ColumnContainer', 'LabeledImageList', 'LocalStorage', "WebLink", "Download"],
			...
			hasValidation : ["TextBox", "TextArea", "TypeAheadTextBox", "Password", "CheckBox", "Switch", "Date", "DateDropDown",
							...
							'ProgressSegments', 'ImagePaging', 'LabeledCheckBox', 'LabeledRadioBox', 'Button', 'LabeledTextBox', 
							'Chat', 'TabBar', 'DataGrid', 'IFrameWidget', 'API', 'AudioPlayer', 'AudioRecording', 
							'GeoLocation', 'LabeledImageList'],

			hasDataBindingLinks: ['DataGrid', 'Table'],
							
			hasLogic2: ["LogicOr", "LogicAnd", "Rest", "Script", "OpenAIAssistant", 'PromptBuilder', "API", "AIRest", "DocToText", "TextToDoc", "LocalStorage", "Download", 'CopyClipboard'],
	
			hasErrorViewMode : ["TextBox", "Password", "CheckBox", "Switch", "DropDown", "MobileDropDown", "DateDropDown", 
								"TypeAheadTextBox", "CheckBoxGroup", "RadioGroup", 'LabeledCheckBox', 'LabeledRadioBox', 'TextArea'],
			hasFocusViewMode : ["TextBox", "Password", "MobileDropDown", "TextArea", "TypeAheadTextBox", 'LabeledTextBox', 'Chat'],
			hasCheckedViewMode : ["CheckBox", "RadioBox", "RadioBox2"],
			hasActiveViewMode : ["SegmentButton", "ToggleButton","VolumeSlider", "Tree", 
								 "VerticalNavigation", 'Paging', 'Upload', 'IconToggleButton', 
								 'NavBar', 'TabBar', 'AudioRecording', 'Repeater', "Separator"],
			hasHoverViewMode: ["Box", "Button", "Label", "ToggleButton", "DragNDrop", "Upload", "WebLink", "Tree", "Camera", 
								...
								"DropDown", "TextBox", 'LabeledTextBox', 'TypeAheadTextBox', 
								'TextArea', 'NavBar', 'NavMenu', 'TabBar', 'AudioRecording', 'GeoLocation', 'LabeledImageList', 'Chat'],
    ...
    methods: {
        onModeChange (){
			...
			if (this.domNode){
				...
				if(this.mode == "addRound"){
					css.add(this.roundTool, "MatcToolbarItemActive" );
				}
				if(this.mode == "addSeparator"){
					css.add(this.separatorTool, "MatcToolbarItemActive" );
				}
		...
		**********************************************************************/
		...
		renderToolbar (){
			...
			* Tools section
			*/
			this.layer = this.$new(ToolbarDropUpButton, {arrowPosition:false, hasCaret: true, hasArrow:true, qPlacement: 'top'});
			this.layer.setIcon('Layer') //.setLabel('<span class="mdi mdi-layers-outline"></span>');
			...
			this.template = this.createToolBarIconItem(
				'Component',
				lang.hitch(this,"onToolCreateTemplate"), null, this.templateDiv
			);			
			this.addTooltip(this.template, "Create a reusable component. You can find it in the widget menu.", "vommondToolTipTop");	

			this.templateDropBox = this.$new(ToolbarDropUpButton, {arrowPosition:false, hasCaret: true, hasArrow: true, placement: 'top'});
			this.templateDropBox.setIcon('ComponentContained') //.setLabel('<span class="mdi mdi mdi-rhombus-split"></span>');
			...
			this.replicateBtn = this.createToolBarIconItem('Replicate', lang.hitch(this,"onToolbarReplicate"), null, this.templateDiv);
			this.distributeBtn = this.createToolBarIconItem('Grid', lang.hitch(this,"onToolbarGridResize"), null, this.toolsDiv);		
		...
		renderToolTips (){			
			// this.addTooltip(this.addScreenSection, "Add Screens (S)", "");
			// this.addTooltip(this.addSection, "Add Widgets and Screens (W)", "");
			// this.addTooltip(this.paletteBtn, "Set App Themes", "");
			// this.addTooltip(this.$refs.layersItem, "App Layers", "");
			// this.addTooltip(this.$refs.dataItems, "Variables", "");
			// this.addTooltip(this.$refs.addLogicSection, "Add Rest, Scripts and Logic", "");
			// this.addTooltip(this.designGptBtn, "AI Generator - Text to Design", "");
		
			this.addTooltip(this.distributeBtn, "Distribute (D) object equally", "vommondToolTipTop");
			this.addTooltip(this.groupBTN, "Create group (CTRL-G)", "vommondToolTipTop");
			this.addTooltip(this.ungroupBTN, "Remove group (CTRL-G)", "vommondToolTipTop");
			this.addTooltip(this.replicateBtn, "Clone selection (C)", "vommondToolTipTop");
			if (this.addCommentSection) {
				this.addTooltip(this.addCommentSection, "Add comment", "vommondToolTipTop")
			}
		},
		showPropertiesTitle(title) {
			this.propertiesTitle = title;
		},	
		...
		***************************************************************************/
		...
		_onIconsLoaded (icons){
			...
			if (this.createBTNContent){
				this.createBTNContent.setIcons(icons);
			}
		...
		_renderDesignTokens () {
			...
			const parent = this.createSection("");

			const content = document.createElement("div");
			css.add(content, "");
			parent.appendChild(content);

			this.designTokenList = this.$new(ThemeVariableList)
			this.designTokenList.placeAt(content)
			this.own(on(this.designTokenList, "change", lang.hitch(this, "changeThemeVariable")));
		...
		****************************************************************************************************/
		...
		_renderGroupResponsive (){
			...
			this.groupPositionCheckBox.setLabel("Fixed position");
			this.addTooltip(this.groupPositionCheckBox.domNode, "The element will not scroll.")
			...
			// this.groupWrappCheckBox = this.$new(CheckBox);
			// this.groupWrappCheckBox.setLabel("Wrap children on mobile");
			// this.addTooltip(this.groupWrappCheckBox.domNode, "The element will not scroll.")
			// css.add(this.groupWrappCheckBox.domNode, "MatcToolbarItem");
			// this.own(on(this.groupWrappCheckBox, "change", lang.hitch(this, "setGroupProperties", "wrapped")));
			// this.groupWrappCheckBox.placeAt(content)
		...
		****************************************************************************************************/
		...
		_renderWidgetAlign (){
			const content = document.createElement("div");
			css.add(content, "MatcToolbarSectionContent  MatcToolbarSectionBorderTop");
		...
		// 	const content = document.createElement("div");
		// 	css.add(content, "MatcToolbarSectionContent MatcToolbarSectionAlignButtons");
		...
		_renderWidgetResponsive (){
			...
			this.positionCheckBox.setLabel("Fixed position");
			this.addTooltip(this.positionCheckBox.domNode, "The element will not scroll.")
		...
		_renderWidgetMinMax () {
			...
			* Responsive
			*/
			const parent = this.createSection("Responsive", true);
			const content = document.createElement("div");
			css.add(content, "MatcToolbarSectionContent");
			parent.appendChild(content);
		...
		_renderData (){
			...
			this.dataWidget.setSchema(this.schema);
			...
			this.dataWidget.setSecretKeys(this.secretKeys)
			this.dataWidget.setSectionHeader(parent);
			this.dataWidget.setOrganization(this.selectedOrg)
		...
		_renderDataBindingLinks () {

			const parent = this.createSection("References");

			const content = document.createElement("div");
			css.add(content, "MatcToolbarSectionContent");
			parent.appendChild(content);

			const dataLinkDiv = document.createElement("div");
			content.appendChild(dataLinkDiv);

			this.dataBindingLinkWidget = this.$new(DataBindingLinks);
			this.dataBindingLinkWidget.setModel(this.model);
			this.dataBindingLinkWidget.placeAt(dataLinkDiv);
			this.own(on(this.dataBindingLinkWidget, "newDataBindingLink", (model, databinding, action, e) => {
				this.onNewDataBindingLine(model, databinding, action, e)
			}));
			this.own(on(this.dataBindingLinkWidget, "removeLine", lang.hitch(this, "removeLine")));
			this.own(on(this.dataBindingLinkWidget, "removeLineById", lang.hitch(this, "removeLineById")));
		
			this.properties.appendChild(parent);
			this.dataLinkDiv = parent;
		},
		...
		_renderValidation (){
			...
			this.validationWidget = this.$new(ValidationSection, {schema: this.schema});
		...
		_renderWidgetLine (){
			...
			var parent = this.createSection("Links");
			...
			this.actionBTN.setSchema(this.schema);
		...
		_renderLineDetails () {
			const parent = this.createSection( "Link", true, this.designTokenPaddingBtn);

			const content = document.createElement("div");
			css.add(content, "MatcToolbarSectionContent");
			parent.appendChild(content);

			this.lineDetails = this.$new(LineDetails)
			this.lineDetails.setModel(this.model)
			this.lineDetails.placeAt(content)
			this.own(on(this.lineDetails, "onDelete", () => {
				this.removeLine()
			}))

			this.lineDetailsDiv = parent;
			this.properties.appendChild(parent);
		},
		...
		_renderConditionalStyle () {
			const parent = this.createSection("Visibility");
			...
			this.condStyle.setModel(this.model)
			this.condStyle.setSchema(this.schema)
			this.condStyle.placeAt(content)
			this.own(on(this.condStyle, "change", lang.hitch(this, "setWidgetProps", "condStyles")));
		...
		****************************************************************************************************/
		...
		_renderMultiPosition (){
			...
			this.multiPositionCheckBox.setLabel("Fixed position");
			this.addTooltip(this.multiPositionCheckBox.domNode, "The element will not.")
		...
		****************************************************************************************************/
		...
		_renderScreenImage () {
			...
			var parent = this.createSection( "Background Image", true);
		...
		_renderScreenAnimations (){
			...
			var parent = this.createSection("Animations", false, false, false, HelperUtil.ANIMATIONS);
			...
			*/
			...
			var add = db.div("MatcToolbarIconButton MatcPointer MatcToolbarItem ").build(content);
		...
		_renderScreenInheritance (){
			var parent = this.createSection( "Master Screens", false, false, false, HelperUtil.SCREEN_MASTER);
		...
		// now lets create the setScreenType function
		setScreenType (value){
			const start = value === "start"
			const segment = value === "segment"
			const overlay = value === "overlay"
			this.setScreenStart("start", start);
			this.setScreenSegement("segment", segment);
			this.setScreenStyle("overlay", overlay);
		},
		_renderScreen (){

			var parent = this.createSection( "Screen Type", false, false, false, HelperUtil.SCREEN_SEGMENTS);

			var item = document.createElement("div");

			item = document.createElement("div");
			css.add(item, " MatcToolbarGridFull ml-2");
			...
			this.screenTypeList = this.$new(RadioBoxList);
			this.screenTypeList.setOptions([
				{ value: undefined, label: "Default Screen" },
				{ value: "start", label: "Start Screen" },
				{ value: "segment", label: "Segment" },
				{ value: "overlay", label: "Popup" }
			]);
			this.own(on(this.screenTypeList, "change", lang.hitch(this, "setScreenType")));
			this.screenTypeList.placeAt(item);
			content.appendChild(item);
			
			this.overlayOptions = document.createElement("div");
			css.add(this.overlayOptions, "MatcToolbarGridFull ml-4");
			var overlayOptionsTitle = document.createElement("div");
			css.add(overlayOptionsTitle, "MatcToolbarItemLabel");
			overlayOptionsTitle.innerHTML = "Popup Options";
			this.overlayOptions.appendChild(overlayOptionsTitle);

			this.screenFixedOverlayCheckBox = this.$new(CheckBox);
			this.screenFixedOverlayCheckBox.setLabel("Fixed as overlay");
			this.addTooltip(this.screenFixedOverlayCheckBox.domNode, "The element will not scroll when shows as overlay")
			...
			this.screenFixedOverlayCheckBox.placeAt(this.overlayOptions);
			...
			this.screenBlurOverlayCheckBox.placeAt(this.overlayOptions);
			...
			*/
			...
			this.screenBackgroundOverlayCheckBox.placeAt(this.overlayOptions);

			item.appendChild(this.overlayOptions)
		...
		****************************************************************************************************/
		...
		createSection (lbl, hasTemplateMarker, plusCallback, settingsCallback, helper){

			var parent = document.createElement("div");
			css.add(parent, "MatcToolbarSection");

			var header = this.createSectionHeader( parent, lbl,hasTemplateMarker, plusCallback, settingsCallback, helper);
		...
		createSectionHeader (parent, lbl, hasTemplateMarker, designTokenWidget, settingsCallback, helperUrl){
			var div = document.createElement("div");
			
			if (lbl){
				if (helperUrl) {
					const container = document.createElement("div");
					css.add(container,"MatcToolbarSectionLabelContainer");
					const label = document.createElement("span");
					css.add(label, "MatcToolbarSectionLabel");
					label.textContent = lbl;
					container.appendChild(label);
					const help = document.createElement("a");
					css.add(help, "MatcToolbarSectionHelper mdi mdi-help-circle-outline");
					...
					//this.own(on(help, touch.press, helper));				
		...
		createToolBarIconItem (icon, callback, clazz, parent){
			const a = document.createElement("a");
			css.add(a,"MatcToolbarItem");
		...
		updateImports () {
			if (this.createBTNContent) {
				this.createBTNContent.updateImports()
			}
		},
