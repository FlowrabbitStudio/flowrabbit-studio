    ...
    methods: {
		...
		****************************************************************************************************/
		...
		hideTools (){
			...
			this.toolsHiden = true;
		},

		showDevTools () {
			if (this.isDeveloperMode) {
				css.remove(this.developerDiv, "MatcToolbarSectionHidden");
				this.toolsHiden = false;
			}
		},

		// hideEditToggleButtons() {
		// 	css.add(this.editModeToggleButton, "MatcToolbarSectionHidden");
		// },

		// showEditToggleButtons() {
		// 	css.remove(this.editModeToggleButton, "MatcToolbarSectionHidden");
		// },
		...
		hideAllSections (){
			...
			if (this.dataLinkDiv) {
				css.add(this.dataLinkDiv, "MatcToolbarSectionHidden")
			}
			...
			css.add(this.lineDetailsDiv, 'MatcToolbarSectionHidden')
			css.add(this.toolsDiv, "MatcToolbarSectionHidden");
