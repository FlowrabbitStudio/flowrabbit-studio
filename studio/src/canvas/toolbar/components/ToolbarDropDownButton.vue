<template>
	<div
		:class="['MatcToolbarPopUpCntr', { 'MatcToolbarIconDropDownButton': isIconButton }, { 'MatcToolbarArrowDropDown': hasArrow }]">
		...
		<div class="MatcToolbarPopUp MatcToolbarDropDownButtonPopup" role="menu" data-dojo-attach-point="popup">
			...
			<div class="MatcToolbarPopUpArrowCntr" v-if="hasArrow">
...
export default {
	...
	props: ["qOptions", "qValue", 'qUpdateLabel', 'qReposition', 'qMaxLabelLength', 'qPopupCSS', 'qPostfix', 'hasArrow', 'isDialog'],
