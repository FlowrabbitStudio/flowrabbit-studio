...
<template>
     <div class="MatcToolbarTableSettings">
      ...
      <div class="MatcToolbarTabs MatcToolbarTabsBig">
            <a @click="tab='columns'" :class="{'MatcToolbarTabActive': tab === 'columns'}">
                Columns
                <!-- <a class="MatcToolbarSectionHelper mdi mdi-help-circle-outline"></a> -->
            </a>
            <a @click="tab='actions'" :class="{'MatcToolbarTabActive': tab === 'actions'}">
                Actions
                <!-- <a class="MatcToolbarSectionHelper mdi mdi-help-circle-outline"></a> -->
            </a>
            <a @click="tab='data'" :class="{'MatcToolbarTabActive': tab === 'data'}">
                Dummy Data                
                <!-- <a class="MatcToolbarSectionHelper mdi mdi-help-circle-outline"></a> -->
            </a>
            <!-- <a @click="tab='wizard'" :class="{'MatcToolbarTabActive': tab === 'wizard'}">
                Table Wizard             
            </a> -->
        </div>
        ...
        <div class="MatcToolbarTableSettingsCntr">
            ...
            <div v-if="tab === 'data'" class="">
                <DataTable
                    ...
                    @colNameChange="setColumnName"
                    @change="setData"
                />
            </div>

            <div v-if="tab === 'wizard'" class="">
                <TableWizard :app="model" :schema="schema" :widget="widget" @import="updateColumns"></TableWizard>
            </div>
                       ...
                       <tbody>
                            ...
                            <tr class="MatcFormRow" v-for="(action, i) in props.tableActions" :key="i">
                                ...
                                <td class="MatcFormRowRemove">
                                    <div class="MatcFormRowRemoveCntr">
                                        <span class="mdi mdi-close " @click="removeAction(i)"/>
                                    </div>
                   ...
                   <table  class="MatcToolbarTableSettingsTable">
                       <thead>
                            <tr class="MatcFormRow">
                                ...
                                <th style="width:50px;">            
                                    <!-- <span class="mdi mdi-close " @click="guessColumns()"></span> -->
                                </th>
                            </tr>
                       </thead>
                        <tbody>
                            ...
                            <tr 
                                ...
                                <td>
                                    ...
                                    <Combo 
                                        :value="column.databinding" 
                                        @change="setColumnDataBinding(i, $event)" 
                                        :hints="databindingHints" 
                                        :fireOnBlur="true" 
                                        :formControl="true"
                                        :isDropDown="true" 
                                ...
                                <td class="MatcFormRowRemove">       
                                    <div class="MatcFormRowRemoveCntr">                        
                                        <span class="mdi mdi-close"  @click="removeColumn(i)"/>         
                                    </div>                      
                                </td>
                            </tr>
...
export default {
    ...
    computed: {
        databindingHints () {
            ...
            const hints = SchemaUtil.getAllPaths(this.schema)
            const filtered = SchemaUtil.removeParentPrefix(hints, input)
    ...
    methods: {
       ...
       onActionDrop (e, i) {
        ...
        updateColumns (columns) {
            this.$set(this.props, 'columns', columns)
            this.tab = 'columns'
        },
        ...
        guessColumns () {
            if (this.schema && this.widget?.props?.databinding?.default) {
                ...
                const columns = childPaths.map(c => {
                    return {
                        id: c,
        ...
        setColumnDataBinding (i, value) {
            console.debug('setColumnDataBinding', i)
            this.props.columns[i].databinding = value
        },
