        ...
        <div class="MatcDialogContent">
            ...
            <div class="MatcMarginTop">
                 <div class="form-group">
                        ...
                        <DropDownButton :value="outputFormat" :options="formatOptions"
                            @change="onChangeOutputFormat" placeholder="The format of the output document">
                        </DropDownButton>
                    </div>           
                <label>Text Variable
                ...
                <div class="form-group">
                     <Combo :value="rest.input.databinding" @change="onChangeInputVar" :hints="hints" :fireOnBlur="true"
    ...
    methods: {
        ...
        setWidget(w) {
            ...
            if (w.props && w.props.rest) {
                ...
                if (this.rest.output && this.rest.output.format) {
                    this.outputFormat = this.rest.output.format;
                }
            }
        },
        setModel(m) {
        ...
        onChangeInputVar(value) {
            ...
            this.rest.input.fileDataBinding = undefined
            this.onChange()
        },
        onChange() {
            this.$nextTick(() => {
        ...
        async run() {
            ...
            try {
                const result = await DocEngine.runTextToDoc(this.rest, this.databingValues, this.hash, this.model.id);
