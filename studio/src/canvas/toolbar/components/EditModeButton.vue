...
<template>
  <div :class="['MatcToolbarEditMode', {'MatcToolbarEditModeAnimated': animated}]">
   ...
   <div class="MatcToolbarEditModeCntr" ref="cntr">
     ...
     <a @click="setDesign" :class="['MatcToolbarEditModeItem', {'MatcToolbarEditModeActive': canvasViewMode === 'design'  }]" ref="btnEdit">     
         Design
     </a>
     <a @click="setPrototype" :class="['MatcToolbarEditModeItem', {'MatcToolbarEditModeActive': canvasViewMode === 'prototype' }]" ref="btnProto">
           Flow
     </a>
