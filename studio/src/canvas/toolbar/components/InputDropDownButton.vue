...
<template>
    <div class=" MatcToolbarItem MatcToolbarDropDownButton MatcToolbarInputDropDownButton">
		<div data-dojo-attach-point="button" class="MatcToolbarInputDropDownButtonCntr">
			...
			<span class="mdi mdi-chevron-down" v-if="!qIcon"></span>
		</div>
...
export default {
	...
	props: ['qIcon', 'qIsDropDown', 'qPlacement'],
    data: function () {
        return {
            type: "int",
            allowA: false
