...
export default {
  name: 'Canvas',
    ...
    components: {
		SVGEditor, ContextMenu, LineMenu
	},
    methods: {
		postCreate (){
		...
		setDNDError(id, msg) {
			css.add(this.frame, "MatcDnDError");
			this._dndErrorDiv = this.widgetDivs[id];
			if (this._dndErrorDiv) {
				css.add(this._dndErrorDiv, "MatcDnDErrorBox");
			}

			this._dndErrorBackgroundDiv = this.widgetBackgroundDivs[id];
			if (this._dndErrorBackgroundDiv) {
				css.add(this._dndErrorBackgroundDiv, "MatcDnDErrorBox");
			}
		...
		cleanUpDNDError() {
			css.remove(this.frame, "MatcDnDError");
			if (this._dndErrorDiv) {
				css.remove(this._dndErrorDiv, "MatcDnDErrorBox");
			}
			if (this._dndErrorBackgroundDiv) {
				css.remove(this._dndErrorBackgroundDiv, "MatcDnDErrorBox");
			}
			this._dndErrorDiv = null;
			this._dndErrorBackgroundDiv = null;
		},
