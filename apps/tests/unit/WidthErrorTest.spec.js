...
test('Test Nest Groups', () => {
  ...
  console.debug(TestUtil.print(screenStart))
  let startScenario1 = TestUtil.findOneElementsByName(screenStart, 'Scenario1_g11601')
...
/**
 ...
 let cssScenario = TestUtil.findCSSBySelector(classes, '.Scenario1_g11601')[0]
