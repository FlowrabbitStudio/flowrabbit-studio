...
public class InvitationRestTest extends BaseTestCase {
	...
	public void test(TestContext context){
		...
		getInvitationError(klaus_app_public, context);
		...
		// works but cannot be tested because there are no hashes in db
		//assertInvitationApp(klaus_app_private, 3,context);


		
		assertLogin(context, "bernd@quant-ux.de", "123456789");
		//assertInvitationE(klaus_app_public, 6, context);
		assertInvitationApp(klaus_app_private, 3, context);
	...
	public void assertInvitationApp(App app, int event, TestContext context){
		...
		/**
		 * Make sure other hashs don't work
		 */
