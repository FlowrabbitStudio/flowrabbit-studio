...
public class PublicationSettingsRestTest2 extends BaseTestCase {



    @Test
    public void test_domain(TestContext context) {
        log("test_domain", "enter");
        ...
        jansOrg.put(Organization.FIELD_DOMAINS, new JsonArray().add("jan.com").add("app.jan.de"));
        adminUpdateOrganization(context, jansOrg);
        ...
        getPublicTokenByDomain("jan.com", "AAA", context);
        getPublicTokenByDomain("app.jan.de", "AAA", context);
        // some wrong stuff
        getPublicTokenByDomainError("wrong.de", "AAA", context);
        getPublicTokenByDomainError("app.jan.de", "WRONG", context);
