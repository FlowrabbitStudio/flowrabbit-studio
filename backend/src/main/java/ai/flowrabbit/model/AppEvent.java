...
import ai.flowrabbit.bus.AppEventHandler;
...
public class AppEvent extends Model{
	...
	public static final String TYPE_USER_NOT_PAID_LOGIN ="TYPE_USER_NOT_PAID_LOGIN";
	...
	public static final String TYPE_CONNECTION_CHECK_ERROR ="TYPE_CONNECTION_CHECK_ERROR";

	public static final String TYPE_OPEN_AI = "TYPE_OPEN_AI";

	public static final String TYPE_SECRET_REQUEST= "TYPE_ORG_TOKEN_REQUEST";

	public static final String TYPE_ORGANISATION_TEAM_ADD = "TYPE_ORGANISATION_TEAM_ADD";

	public static final String TYPE_ORGANISATION_TEAM_INVITE = "TYPE_ORGANISATION_TEAM_INVITE";

	public static final String TYPE_APP_STORE_PURCHASE = "TYPE_APP_STORE_PURCHASE";

	public static final String TYPE_SECRET_REQUEST_PURCHASE= "TYPE_SECRET_REQUEST_PURCHASE";
