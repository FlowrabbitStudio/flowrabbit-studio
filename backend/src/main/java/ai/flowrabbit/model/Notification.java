...
public class Notification extends Model{
	 ...
	 */
	public static JsonObject findByUserOrPublic(String id, String domain){
		JsonObject queryUserID = new JsonObject().put("userID", id);
		JsonObject queryisPublic = new JsonObject().put("isPublic", true);
		return new JsonObject().put("domain", domain).put("$or",  new JsonArray().add(queryUserID).add(queryisPublic));
	}
