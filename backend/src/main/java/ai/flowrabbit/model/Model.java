...
public abstract class Model {
	...
	public static JsonObject findByStripeSubscriptionId(String id){
		return new JsonObject().put("stripe.subscriptionID", id);
	}
	...
	public static JsonObject newerThan(long date){
		return new JsonObject()
				.put(FIELD_CREATED,  new JsonObject().put("$gte", date));
	}

	public static JsonObject in(long from, long end){
		return new JsonObject()
				.put(FIELD_CREATED,  new JsonObject().put("$gte", from).put("$lte", end));
	}

	public static JsonObject olderThan(long date){
		return new JsonObject()
				.put(FIELD_CREATED,  new JsonObject().put("$lte", date));
	}
