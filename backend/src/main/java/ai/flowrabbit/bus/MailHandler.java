...
public class MailHandler implements Handler<Message<JsonObject>>{
	 ...
	 * Templates
	 */
	public static final String TEMPLATE_PASSWORD_RESET ="user_rest";
	...
	public static final String TEMPLATE_START_UP = "start";

	public static final String TEMPLATE_ORG_ADD = "org_add_user";

	public static final String TEMPLATE_ORG_INVITE = "org_invite";
	...
	public MailHandler(Vertx vertx, MailClient mail, String from, String serverHost){
		...
		vertx.executeBlocking(handler -> {
			...
			triggerUnzip(templateFolder, TEMPLATE_PASSWORD_RESET);
			...
			readTemplate(templateFolder, TEMPLATE_START_UP);
			readTemplate(templateFolder, TEMPLATE_HTML_FRAME);
			readTemplate(templateFolder, TEMPLATE_PASSWORD_RESET);
			readTemplate(templateFolder, TEMPLATE_ORG_ADD);
			readTemplate(templateFolder, TEMPLATE_ORG_INVITE);
			handler.complete();
		}, result -> {
	...
	private void triggerUnzip(String folder, String templateName) {
