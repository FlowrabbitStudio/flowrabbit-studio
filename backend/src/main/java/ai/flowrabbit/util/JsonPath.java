...
public class JsonPath {
	...
	public static String getString(JsonObject j, String...path) {
		return new JsonPath((j)).getString(path);
	}

	public static int getInteger(JsonObject j, String...path) {
		return new JsonPath((j)).getInteger(path);
	}
}
